...
const About = () => {
  return (
    <div className="p-4 ml-8 mr-8">
      <h1 className="text-2xl font-bold" aria-label="Titre" tabIndex="0">Les biais cognitifs et les croyances en pseudo-sciences</h1>
      ...
      <div className="p-4">
      <p tabIndex="0">Les pseudo-sciences, telles que la lithothérapie, l’astrologie ou encore la voyance,
      ...
      <br/>
      <p tabIndex="0">L'un des principaux biais en jeu est le <strong>biais de confirmation</strong>. Lorsqu'une personne 
      ...
      <br/>
      <p tabIndex="0">Un autre biais est <strong>l'effet Barnum</strong>, Ce biais explique pourquoi des descriptions générales 
      ...
      <br/>
      <p tabIndex="0"><strong>L’illusion de causalité</strong> joue également un rôle. Les humains ont tendance à établir des liens 
      ...
      <br/>
      <p tabIndex="0"><strong>Le biais d’autorité</strong> est aussi à considérer. Lorsqu'une personne perçoit un praticien de 
      ...
      <br/>
      <p tabIndex="0">Enfin,<strong>le biais d'engagement</strong> et de cohérence explique pourquoi les gens peuvent 
      ...
      <br/>
      <p tabIndex="0">Ces biais, combinés, offrent un cadre explicatif puissant pour comprendre pourquoi des individus 
