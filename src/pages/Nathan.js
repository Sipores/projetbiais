...
const Nathan = () => {
  ...
  return (
    <div className="p-4 ml-8 mr-8">
      <h1 className="text-4xl font-bold text-center mt-4 mb-6" tabIndex="0">
      ...
      <article>
        <section id="section1" className="mt-6" tabIndex="0">
        ...
        <section id="section2" className="mt-6" tabIndex="0">
        ...
        <section id="section3" className="mt-6" tabIndex="0">
        ...
        <section id="section4" className="mt-6" tabIndex="0">
        ...
        <section id="section5" className="mt-6" tabIndex="0">
        ...
        <section id="section6" className="mt-6" tabIndex="0">
        ...
        <section id="section7" className="mt-6" tabIndex="0"  >
        ...
        <section id="section8" className="mt-6" tabIndex="0"  >
