...
const Nathan = () => {
    ...
    const handleKeyDown = (event) => {
        const sectionIds = [
          ...
          if (event.altKey && sectionNumber >= 1 && sectionNumber <= 7) {
  ...
  return (
    <div className="p-4 ml-8 mr-8">
      ...
      <article>
        <section id="section1" className="mt-6">
        ...
        <section id="section2" className="mt-6">
        ...
        <section id="section3" className="mt-6">
        ...
        <section id="section4" className="mt-6">
        ...
        <section id="section5" className="mt-6">
        ...
        <section id="section6" className="mt-6">
        ...
        <section id="section7" className="mt-6">
