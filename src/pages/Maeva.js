  ...
  return (
    <article
            ...
            <header className="mb-6">
                <h1 id="essay-title" className="text-3xl font-bold text-gray-900 mb-2">
            ...
            <section aria-labelledby="halo-bias" className="mb-6">
            ...
            <section aria-labelledby="consequences" className="mb-6">
